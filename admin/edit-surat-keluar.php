                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                     ...
                     <div class="item form-group">
                      ...
                      <input type="hidden" name="fotolama" value="<?=$r['file_surat']; ?>">
  <label  class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Nama surat <span class="required">*</span>
  </label>
  <div class="col-md-6 col-sm-6 ">
    <input type="text" id="first-name" name = "nama_surat" required="required" value="<?=$r['nama_surat']; ?>" class="form-control ">
  </div>
</div>
<div class="item form-group">
  ...
  <div class="col-md-6 col-sm-6 ">
    <input type="date" id="last-name" name="tanggal_keluar" required="required" class="form-control" value="<?=$r['tanggal_keluar']; ?>" >
  </div>
</div>
<div class="item form-group">
  <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">No Surat</label>
  <div class="col-md-6 col-sm-6 ">
    <input id="middle-name" class="form-control" type="text" value="<?=$r['nomor_surat']; ?>" name="nomor_surat">
  </div>
</div>
