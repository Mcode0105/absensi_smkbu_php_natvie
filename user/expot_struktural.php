...
<head>
	...
	<title>data kehadiran Struktural</title>
...
<h2 style="text-align: left;" >data kehadiran struktural</h2>
...
<table border="1">
	...
	$res = mysqli_query($conn, "SELECT * FROM presensi_struktural WHERE nama = '$username' ");
