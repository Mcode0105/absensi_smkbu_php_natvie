...
<div class="item form-group">
  <label  class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">tanggal surat masuk <span class="required">*</span>
  </label>
  <div class="col-md-6 col-sm-6 ">
    <input type="date" id="first-name" name = "tanggal_masuk" required="required" class="form-control ">
  </div>
</div>
                  ...
                  <?php while ( $row = mysqli_fetch_assoc($result) ) : ?>
                        ...
                        <?= $row['file_surat'];?> 
                          ...
                          <td>
                            ...
                            <a href="edit-surat-masuk.php?id=<?=$row['id']; ?>" class="btn btn-info btn-sm"><i class="fa fa-pencil"></i> Edit </a>
