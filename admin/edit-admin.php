...
$r = mysqli_fetch_assoc($res);
              ...
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  ...
                  <div text align="center" class="title_center">
                    ...
                    <img class="img-circle profile_img" style="width: 200px; height: 200px " src="images/<?=$r['foto'] ?>" >
              </div>
                  <div class="x_content">
  ...
  <div class="col-md-6 col-sm-6 ">
    <input type="text" id="first-name" name = "username" required="required" value="<?=$r['username']; ?>" class="form-control ">
  </div>
</div>
<div class="item form-group">
  <label class="col-form-label col-md-3 col-sm-3 label-align">pasword<span class="required">*</span>
  </label>
  <div class="col-md-6 col-sm-6 ">
    <input id="birthday" name ="password" class="date-picker form-control"  type="password" value="<?= $r['password']; ?>"	>
  </div>
</div>
